...
The basic blast. Kick and snare alternate on every sixteenth note. Cymbal rides on eighths or sixteenths.
...
- Gravity blast / one-handed roll: Snare on every 32nd note bursts (2-4 beats max). Extremely fast, used as accent moments and never sustained.
...
1. Kick and snare are near-simultaneous, NOT alternating. That near-simultaneity is what makes it a burst beat rather than a blast beat.
...
- The polyrhythmic accents should be metronomically precise: Greg Fox's accent pattern is deliberate.
...
Timing: Can be slightly sloppy (humanize 0.8+). Aim for violence rather than precision.
...
- Snare ghost: 25-45. Very quiet, felt rather than heard distinctly.
...
- Humanize: 0.6-0.7. Enough to breathe while staying tight.
...
### Philosophy
Musical restraint with explosive release. The drums SERVE the dynamics of the song. Quiet sections are genuinely quiet. Loud sections are genuinely loud. Floor tom carries melody here, well beyond fill duty. Canty plays behind the beat for groove and ahead of the beat for urgency.
...
### Philosophy
Unpredictable. The drums follow the guitar's angular movements rather than keeping steady time. Feels like the pattern is constantly about to fall apart but never does. Time signatures shift mid-phrase. The drummer REACTS to the guitars rather than laying down a foundation.
...
The 4/4 bar followed by a bar that feels like it has a beat missing creates the signature Polvo "did they just mess up?" feeling. The dropped beat is deliberate.
...
### Philosophy
Extremes. Blast beats next to total silence. No middle ground. The dynamics ARE the composition. Sloppiness is authentic. The target is emotional catharsis, and too clean a take reads as wrong.
...
### Philosophy
More compositional than US emoviolence. Dynamics are carefully built rather than smashed together. Post-rock influence in the build sections. When it blasts, it EARNS the blast through patient tension building. The emotional arc is everything.
...
Fast kick doubles but NOT blast speed. Eighth note ride throughout, never sixteenth. The pattern has momentum without going full blast. This is the Daitro sweet spot, intense but not unhinged.
